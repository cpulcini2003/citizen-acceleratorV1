...
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug config/postgresClaimCreate.sh didn't match [README.md] -> included
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug config/postgresInfo/postgres.yaml didn't match [README.md] -> included
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug config/postgresInfo/usefull_command.txt didn't match [README.md] -> included
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug config/postgresClaimCreate.sh didn't match [README.md] -> excluded
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug config/postgresInfo/postgres.yaml didn't match [README.md] -> excluded
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug config/postgresInfo/usefull_command.txt didn't match [README.md] -> excluded
...
┃ ┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [ARTIFACTID->citizen-accelerator]
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug README.md didn't match [config/postgresClaimCreate.sh] -> excluded
